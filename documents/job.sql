create table jobs (
  ...
  description character varying(9800),
  original_link character varying(300),
...
insert into jobs (id,title,description,original_link,published_at,expired_at,position,quantity,location,applicant_count,skills,min_salary,max_salary,company_id) values
	 ('netbird-frontend-software-engineer','Frontend Software Engineer - NetBird','<h3>Who we are</h3>
...
</p>','https://careers.netbird.io/Software-Engineer-Frontend-1456122c188d801eb74fde96307b0afb','2025-01-08 15:34:44.395+07',NULL,'Frontend Software Engineer',1,'Remote',1,'{}',NULL,NULL,'NetBird'),
	 ('netbird-senior-software-engineer','Senior Software Engineer (Network) - NetBird','<h3>Who we are</h3>
<h5>A team from Germany with the vision to make advanced network security accessible for everyone</h5>
<p>
  We are a software company developing an open-source zero-trust network security platform that is both easy to use and affordable for teams of all
  sizes and budgets. Our mission is grounded in a simple yet powerful belief: secure private networking is a fundamental right of every modern company
...
<p>
  ...
  sexual identity, nationality, ethnicity, religion or belief, disability, or age. Please include only the information and documents relevant to
  evaluating your application (e.g., resume and relevant certificates or references). A photo is not required and can be omitted.
</p>','https://careers.netbird.io/Senior-Software-Engineer-Network-1446122c188d813797c7c85884d0a246','2025-01-08 15:34:44.395+07',NULL,'Senior Software Engineer (Network)',2,'Remote',1,'{}',NULL,NULL,'NetBird'),
	 ('triple-a-lead-engineer','GO - Lead Software Engineer - Remote - 60k - 150k USD','<h3>About Triple-A</h3>
<p>
...
</p>','https://www.triple-a.io/careers?utm_medium=website&utm_source=Golangprojects&ref=Golangprojects&source=Golangprojects','2025-01-08 14:34:44.395+07',NULL,'Product Manager',1,'Singapore',1,'{}',NULL,NULL,'Triple A'),
	 ('triple-a-senior-software-engineer','Technology - Senior Software Engineer','<h3>About Triple-A</h3>
<p>
  Triple-A is a global payment institution licensed in the United States, Europe, and Singapore, enabling businesses worldwide to pay and get paid in
  both local and digital currencies.
</p>
...
<p>
  Join us in revolutionizing the payment industry, one transaction at a time. Be at the forefront of embracing both fiat and cryptocurrency to make a
  global impact.
</p>','https://www.triple-a.io/careers?utm_medium=website&utm_source=Golangprojects&ref=Golangprojects&source=Golangprojects','2025-01-08 14:34:44.395+07',NULL,'Senior Software Engineer',5,'Remote',1,'{}',NULL,NULL,'Triple A'),
	 ('triple-a-business-development-director','Business Development - Business Development Director - Singapore','<h3>About Triple-A</h3>
<p>
  Triple-A is a global payment institution licensed in the United States, Europe, and Singapore, enabling businesses worldwide to pay and get paid in
  both local and digital currencies.
</p>
...
<p>
  ...
  hearing from you!
</p>','https://www.triple-a.io/careers?utm_medium=website&utm_source=Golangprojects&ref=Golangprojects&source=Golangprojects','2025-01-08 14:34:44.395+07',NULL,'Business Development Director',1,'Singapore',1,'{}',NULL,NULL,'Triple A'),
	 ('flourish-backend-engineer-go-remote','Backend Engineer (Remote) - 75K to 120K','<h3>About Flourish</h3>
<p>
