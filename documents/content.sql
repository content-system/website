  ...
  <div class="main-body">
    ...
    <ul class="row list">
      <li class="col s6 l3 img-card">
        ...
        />
        <h3 class="sub highlight">Software Development</h3>
        <p>
      ...
      <li class="col s6 l3 img-card">
        ...
        />
        <h3 class="sub highlight">Software Testing</h3>
        <p>
      ...
      <li class="col s6 l3 img-card">
        ...
        <h3 class="sub highlight">Data Services</h3>
        <p>
      ...
      <li class="col s6 l3 img-card">
        ...
        <h3 class="sub highlight">AI &amp; Machine Learning</h3>
        <p>
  ...
  <div class="main-body">
    ...
    <ul class="row list">
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Chu Thi Thanh Ha</h3>
      ...
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Pham Minh Tuan</h3>
      ...
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Nguyen Khai Hoan</h3>
      ...
      <li class="col s6 m4 l3 push-m4 img-card">
        ...
        />
        <h3 class="center sub highlight">Dao Duy Cuong</h3>
    ...
    <ul class="row list">
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Do Van Khac</h3>
      ...
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Dang Tran Phuong</h3>
      ...
      <li class="col s6 m4 l3 img-card">
        ...
        />
        <h3 class="center sub highlight">Mark Scrivens</h3>
      ...
      <li class="col s6 m4 l3 push-m4 img-card">
        ...
        />
        <h3 class="center sub highlight">Christophe Schwanengel</h3>
  ...
  <div class="main-body">
    ...
    <ul class="row list">
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Media & Entertainment</h3>
      ...
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Healthcare</h3>
      ...
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Automotive</h3>
      ...
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Logistics</h3>
      ...
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Banking, Financial Services & Insurance</h3>
      ...
      <li class="col s12 l6 img-card">
        ...
        <h3 class="sub highlight">FPT Manufacturing</h3>
    ...
    <section>
      ...
      <ul class="row list">
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Talent Hub</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">High Standard Delivery</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Effective Cost</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Lifetime Partnership</h3>
            <p>
    ...
    <section>
      ...
      <ul class="row list">
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Our Vision</h3>
            <p>
        ...
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Our Mission</h3>
            <p>
        ...
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Core Value</h3>
            <p>
...
',null,NULL,'A',1),
  ...
  <div class="main-body">
    ...
    <ul class="row list">
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/banner/media-desktop.webp"></img>
        <h3 class="sub highlight">FPT Truyền thông & Giải trí</h3>
      ...
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/industries-healthcare/healthcare-lp_banner.png"></img>
        <h3 class="sub highlight">FPT chăm sóc sức khỏe</h3>
      ...
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/automotive/automotive-lp_banner-3.png"></img>
        <h3 class="sub highlight">FPT xe hơi</h3>
      ...
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/logistics/2880x1000-min.png"></img>
        <h3 class="sub highlight">FPT hậu cần</h3>
      ...
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/bfsi/banner-2.png"></img>
        <h3 class="sub highlight">Ngân hàng, Dịch vụ tài chính và Bảo hiểm FPT</h3>
      ...
      <li class="col s12 l6 img-card">
        <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/manufacturing/ldp_manufacturing_banner1-min.png"></img>
        <h3 class="sub highlight">FPT sản xuất</h3>
  ...
  <div class="view-body">
    ...
    <section>
      ...
      <ul class="row list">
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Trung tâm tài năng công nghệ</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Cung cấp dịch vụ chất lượng cao</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Chi phí hiệu quả</h3>
            <p>
        ...
        <li class="col s12 l6 xl3 card">
          <section>
            <h3 class="sub highlight">Quan hệ đối tác trọn đời</h3>
            <p>
    ...
    <section>
      ...
      <ul class="row list">
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Tầm nhìn</h3>
            <p>
        ...
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Nhiệm vụ</h3>
            <p>
        ...
        <li class="col s12 m4 card">
          <section>
            <h3 class="sub highlight">Giá trị cốt lõi</h3>
            <p>
      ...
      <ul class="row list">
        <li class="col s6 l3 img-card">
          <img
            src="https://fptsoftware.com/-/media/project/fpt-software/fso/services/product-engineering-services/automative-services/auto-services-lp_banner-mobile.webp"
          />
          <h3 class="sub highlight">Phát triển phần mềm</h3>
          <p>
        ...
        <li class="col s6 l3 img-card">
          <img
            src="https://fptsoftware.com/-/media/project/fpt-software/fso/services/product-engineering-services/vehicle-engineering-cad-cae-services/vehicle-engineering-lp_banner-1_mobile.png"
          />
          <h3 class="sub highlight">Kiểm thử phần mềm</h3>
          <p>
        ...
        <li class="col s6 l3 img-card">
          <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/logistics/750x1000-min.png" />
          <h3 class="sub highlight">Dịch vụ dữ liệu</h3>
          <p>
        ...
        <li class="col s6 l3 img-card">
          <img src="https://fptsoftware.com/-/media/project/fpt-software/fso/industries/automotive/automotive-lp_banner-3_mobile.png" />
          <h3 class="sub highlight">Trí tuệ nhân tạo và máy học</h3>
          <p>
