...
insert into users (user_id,username,email,display_name,image_url,status,gender,phone,title,position) values ('tGBxG3ywmt','lee.grant','lee.grant@gmail.com','Lee Grant','https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/LeeGrant09.jpg/250px-LeeGrant09.jpg','A','M','0987654321','Ms','E');
...
insert into users (user_id,username,email,display_name,image_url,status,gender,phone,title,position) values ('xG1GAvBRAa','presnel.kimpembe','presnel.kimpembe@gmail.com','Presnel Kimpembe','https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Presnel_Kimpembe_2022.jpg/250px-Presnel_Kimpembe_2022.jpg','A','M','0987654321','Mr','E');
